// step 4 Show the foreign asset inclusion question when "Yes" is selected
function showForeignAssetQuestion() {
  ...
  function addBeneficiary() {
    ...
    beneficiaryDiv.innerHTML = `
          <div class="form-group">
              <label for="beneficiaryName${beneficiaryCount}">Full name:</label>
              <input type="text" class="form-control" name="beneficiaryName" id="beneficiaryName${beneficiaryCount}" placeholder="Enter beneficiary's full name">
          </div>
  
          <div class="form-group">
              <label for="beneficiaryRelationship${beneficiaryCount}">Relationship to you:</label>
          ...
          <div class="form-group">
              <label for="beneficiaryAddress${beneficiaryCount}">Address or city:</label>
              <input type="text" class="form-control" name="beneficiaryAddress" id="beneficiaryAddress${beneficiaryCount}" placeholder="Enter address or city">
          </div>
  ...
  function addCharity() {
    ...
    charityDiv.innerHTML = `
          <div class="form-group">
              <label for="charityName${charityCount}">Name of charity:</label>
              <input type="text" class="form-control" name="charityName" id="charityName${charityCount}" placeholder="Enter charity name">
          </div>
  
          <div class="form-group">
              <label for="charityAddress${charityCount}">Address or city:</label>
              <input type="text" class="form-control" name="charityAddress" id="charityAddress${charityCount}" placeholder="Enter address or city">
          </div>
  ...
  function showGiftOptions(id, giftCount, type, recipientType) {
    ...
    if (type === "cash") {
      giftOptionFields = `
              <div class="form-group">
                  <label for="cashAmount${id}${giftCount}">Enter the amount (£):</label>
                  <input type="number" class="form-control" id="cashAmount${id}${giftCount}" placeholder="Enter amount">
              </div>
          `
      ...
      giftOptionFields = `
              ...
              <div class="form-group">
                  <label for="propertyAddress${id}${giftCount}">My property located at</label>
                  <input type="text" class="custom-input" id="propertyAddress${id}${giftCount}" placeholder="e.g. 12 Bridge Road W12 N34, London">
                  <small class="helper-text">e.g. 12 Bridge Road W12 N34, London</small>
              </div>
  
              <!-- Property Percentage Field -->
              <div class="form-group input-group-percentage">
                  <input type="number" class="custom-input" id="propertyPercentage${id}${giftCount}" placeholder="100.00" min="0" max="100">
      ...
      giftOptionFields = `
              <div class="form-group">
                  <label for="collectionDescription${id}${giftCount}">Describe the collection:</label>
                  <input type="text" class="form-control" id="collectionDescription${id}${giftCount}" placeholder="Enter collection details">
              </div>
          `
    } else if (type === "item") {
      giftOptionFields = `
  ...
  function showGiftOptions(id, giftCount, type, recipientType) {
    ...
    if (type === "cash") {
      ...
      giftOptionFields = `
              <div class="form-group">
                  <label for="propertyAddress${id}${giftCount}">Enter the property address:</label>
                  <input type="text" class="form-control" id="propertyAddress${id}${giftCount}" placeholder="Enter property address">
              </div>
  
              <div class="form-group">
                  <label for="propertyPercentage${id}${giftCount}">Enter the percentage of the property:</label>
                  <input type="number" class="form-control" id="propertyPercentage${id}${giftCount}" placeholder="Enter percentage" min="0" max="100">
              </div>
          `
    } else if (type === "collection") {
      giftOptionFields = `
